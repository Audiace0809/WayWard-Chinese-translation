...
Messages = {
    savedManually: "Game has been saved manually.",
    saved: "Game has been saved.",
    restarted: "Game has been restarted.",
    deleteSavedData: "All saved content removed. You may refresh this page to see the changes.",
    nextSongPlaying: "Next song playing...",
    soundDisabled: "Music or sound has been disabled.",
    gatheringDisabled: "Automatic gathering disabled.",
    gatheringEnabled: "Automatic gathering enabled.",
    pickupDisabled: "Automatic pickup disabled.",
    pickupEnabled: "Automatic pickup enabled.",
    hintsDisabled: "Hints disabled.",
    hintsEnabled: "Hints enabled.",
    fileNotFound: "File not found!",
    fileNotReadable: "File is not readable!",
    fileError: "An error occurred reading this file.",
    modLoaded: "Modification has been loaded!",
    notSupported: "Your browser does not support this feature.",
    cannotSee: "You cannot see anything here.",
    youSeeTile: "You see _0_.",
    youSeeMonster: "You see _0_.",
    youSeeAberrantMonster: "You see _0_, but something doesn't look right.", //Added 1.9
    creatureHealthy: "The creature appears to be healthy.",
    creatureUnhealthy: "The creature appears to be unhealthy.",
    creatureUnimpaired: "The creature seems unimpaired.",
    creatureHurt: "The creature seems hurt.",
    creatureVeryInjured: "The creature seems very injured.",
    creatureUndamaged: "The creature looks healthy and fairly undamaged.",
    creatureBarelyHurt: "The creature looks barely hurt.",
    ...
    youSeeItems: "You see _0_.",
    youSeeContainer: "You see _0_.",
    containerItems: "This contains: _0_.",
    youUnequip: "You un-equip _0_.",
    equipToShoot: 'You need to equip this to shoot from it!',
    noRoom: 'There is no room to drop that here!',
    inTheWay: "There is something in the way of placing this.",
    waterDrop: 'You drop _0_ into the depths below.',
    waterStir: 'You stir up a creature from the depths!',
    fireDrop: 'You drop _0_ into the fire.',
    fireDropAll: 'You attempt to drop all of _0_ into the fire.',
    cannotDrop: 'You cannot drop _0_ here!',
    dropAllGround: 'You attempt to place all of _0_ on the ground!',
    dropItem: 'You place _0_ on the ground!',
    noRoomContainer: "There is no more room in this container for that item.",
    containerContainer: "You cannot place a container within another container.",
    dropAllContainer: 'You attempt to place all of _0_ in the container!',
    dropContainer: 'You place _0_ in the container.',
    containerBackpack: 'You dump the contents of the container into your backpack!',
    error: "An error has occurred.",
    craftsSortedName: "Crafts sorted by name.",
    craftsSortedSkill: "Crafts sorted by skill.",
    inventory: "Inventory",
    container: "Container",
    sortName: "_0_ sorted by name.",
    sortGroup: "_0_ sorted by group.",
    sortWeight: "_0_ sorted by weight.",
    sortOldest: "_0_ sorted by oldest.",
    sortNewest: "_0_ sorted by newest.",
    gameSavedMB: "Your game has been saved! Your game save is taking up _0_MB.",
    cannotSave: "Your game cannot be saved as your browser does not support local storage.",
    musicMuted: "Music muted.",
    musicUnmuted: "Music unmuted.",
    soundsMuted: "All sounds muted.",
    soundsUnmuted: "All sounds unmuted.",
    sounds50: "All sounds turned to 50% volume.",
    sounds100: "All sounds turned to 100% volume.",
    fireExtinguished: "The fire is almost extinguished.",
    fireStruggling: "The fire is struggling.",
    fireHealthy: "The fire is very healthy.",
    fireRaging: "The fire is raging.",
    plantNotFertile: "The plant is not fertile.",
    plantFertile: "The plant is fertile.",
    plantVeryHealthy: "The plant is very healthy and fertile.",
    awakeContinue: "You awake to discover yourself in the last place you left off...",
    awake: "You awake to find yourself no longer in the company of good men or a fine seafaring vessel. Instead you discover yourself in tattered clothing, with a pocket full of shoddy items. Treasure... you remember something about treasure.",
    experienceBenefits: "Your past experiences provide you benefits for survival.",
    endGame: "After returning the treasure back home, you set off again...",
    killed: "You have been killed!",
    burned: "You have been badly burned! You have lost _0_ health!",
    burnedEquipment: "The flames engulf you, but your equipment protects you from the heat.",
    trampleFire: "You trample the fire, putting it out!",
    killedMonster: "You have killed _0_!",
    overburdened: "You are carrying too much weight!",
    locked: "This object is locked.",
    trapInjured: "You have been injured from a trap!",
    trapNoDamage: "You set the trap off, but it does no damage to you.",
    trapNoActivation: "You move over the trap, but don't set it off!",
    burningPainEnd: "You no longer feel the pain of burning!",
    trampling: "You are trampling _0_.",
    trampled: "You trample _0_ into the ground.",
    monsterTrample: "_0_ tramples _1_ into the ground.",
    destroyed: "_0_ has been destroyed from use.",
    needRepair: "_0_ is in need of repair.",
    caveEntrance: "You have discovered a cave entrance!",
    milestoneEarned: "You have earned the milestone, _0_! _1_",
    itemCrafted: "You crafted _0_!",
    itemCooked: "You cooked _0_!",
    itemPickup: "You picked up _0_.",
    recipeLearned: "You have learned how to create _0_!",
    itemEnvironmentalRequired: "This item requires you to be facing a _0_ in order to craft it.",
    cannotCraft: "You cannot craft here.",
    craftFail: "You fail to _0_ _1_.",
    monsterIdol: "The monster idol attracts another ceature.",
    monsterHit: "_0_ has hit you for _1_ damage! _2_", //Edited 1.9.2
    bleedingStart: "You start bleeding profusely!",
    poisonedStart: "You have been poisoned!",
    monsterMiss: "_0_ has dealt no damage to you.",
    monsterTrapHurt: "_0_ has been hurt by a trap!",
    monsterYourTrapHurt: "_0_ has been hurt by your trap!",
    starvingStart: "You are starving to death!",
    dehydrationStart: "You are dying of dehydration!",
    automaticSave: "Automatically saving your game...",
    bleedingEnd: "The bleeding has stopped!",
    bleedingDamage: "You are bleeding to death! You have lost _0_ health!",
    poisonEnd: "The poison has worked its course!",
    poisonDamage: "You are poisoned! You have lost _0_ health!",
    burningDamage: "You feel a burning pain! You have lost _0_ health!",
    itemDecay: "_0_ has decayed.", //Edited 1.9
    overEating: "You are over-eating! You have lost 10 stamina.",
    overHydrating: "You are over-hydrating! You have lost 10 stamina.",
    gainedHealth: "You have gained _0_ health.",
    lostHealth: "You have lost _0_ health.",
    gainedStamina: "You have gained _0_ stamina.",
    lostStamina: "You have lost _0_ stamina.",
    gainedHunger: "You have gained _0_ hunger.",
    lostHunger: "You have lost _0_ hunger.",
    gainedThirst: "You have gained _0_ thirst.",
    lostThirst: "You have lost _0_ thirst.",
    skillGain: "Your skill in _0_ has raised to _1_%!",
    exhaustion: "You are working yourself into exhaustion!",
    dexterityGain: "You feel yourself becoming more agile!",
    metabolismGain: "Your metabolism is slowing!",
    strengthGain: "You feel yourself getting stronger!",
    noUse: "You cannot think of a way to use this directly.",
    equipItem: "You equip _0_.",
    cantEquipThere: "You can't equip that there!",
    cantEquip: "You can't equip this!",
    fireAmmoObstacle: "You fire _0_ into an obstacle.",
    fireAmmo: "You fire _0_.",
    brokenAmmo: "_0_ has broken while firing!",
    noAmmo: 'You do not have any ammunition for that weapon in your inventory or equipped container!',
    notEnoughStrength: 'You do not have enough strength to throw this!',
    throwObstacle: "You throw _0_ into an obstacle.",
    throwItem: "You throw _0_!",
    brokenImpact: '_0_ has broken on impact!',
    immuneMonster: "_0_ does not seem to be hurting _1_.", //Edited 1.9
    healMonster: "_0_ seems to draw energy from _1_!", //Edited 1.9
    noDamage: "You fail to cause any damage to _0_ with _1_! _2_", //Edited 1.9
    weaponDamagedMonster: "You hit _0_ for _1_ damage with _2_! _3_", //Edited 1.9
    slimeSplit: "_0_ has split.",
    hurtHands: "You hurt your hands hitting _0_ without any weapons!",
    missedMonster: "You missed _0_ with _1_!", //Edited 1.9
    inWayCarving: "There is something in the way of your carving!",
    carveCorpse: "You carve and hack up the corpse.",
    cannotPickupWithItems: "You cannot pick this up with items inside!",
    cannotPickupWhenLit: "You cannot pick this up while it is lit.",
    nothingToCarve: "There is nothing here to carve!",
    noMap: "This map is not of this area.",
    guardians: "You summon the treasure's guardians.", //Edited 1.7.2
...
items.animalskull.name = "An Animal Skull";
items.arrow.name = "An Arrow";
items.arrowhead.name = "An Arrowhead";
items.ashpile.name = "A Pile of Ash";
items.barkleggings.name = "Bark Leggings";
items.barkshield.name = "A Bark Shield";
items.barktunic.name = "A Bark Tunic";
items.bone.name = "A Bone";
items.branch.name = "A Branch";
items.cactusspines.name = "Cactus Spines";
items.charcoal.name = "Charcoal";
//items.cobblestonefloor.name = "Cobblestone Flooring"; //Removed 1.8.1
items.cobblestone.name = "Cobblestone Flooring"; //Added 1.8.1
items.cookedmeat.name = "Cooked Meat";
items.earthworm.name = "An Earthworm";
items.feather.name = "A Feather";
items.fertilesoil.name = "Fertile Soil";
items.seawaterwaterskin.name = "Sea Water in Waterskin";
...
//NPCs
npcs.slime.name = "A Slime";
npcs.jellycube.name = "A Jelly Cube";
npcs.giantspider.name = "A Giant Spider";
npcs.bear.name = "A Bear";
npcs.rabbit.name = "A Rabbit";
npcs.snake.name = "A Snake";
npcs.giantrat.name = "A Giant Rat";
npcs.rat.name = "A Rat";
npcs.vampirebat.name = "A Vampire Bat";
npcs.greywolf.name = "A Grey Wolf";
npcs.imp.name = "An Imp";
npcs.bogling.name = "A Bogling";
npcs.livingrock.name = "A Living Rock";
npcs.shark.name = "A Shark";
npcs.zombie.name = "A Zombie";
npcs.skeleton.name = "A Skeleton";
npcs.pirateghost.name = "A Pirate Ghost";
npcs.timeskitter.name = "A Time Skitter";
npcs.chicken.name = "A Chicken";
npcs.trapdoorspider.name = "A Trap Door Spider";
npcs.fireelemental.name = "A Fire Elemental";
npcs.trout.name = "A Trout";
npcs.hobgoblin.name = "A Hobgoblin";
npcs.livingmushroom.name = "A Living Mushroom";
npcs.kraken.name = "A Kraken";
npcs.blindfish.name = "A Blindfish";
npcs.harpy.name = "A Harpy"; //Added 1.7.4

//Tiles
tiletypes.ash.name = "Ash";
tiletypes.cobblestone.name = "Cobblestone";
tiletypes.darkness.name = "Darkness";
tiletypes.deepwater.name = "Deep Sea Water";
tiletypes.dirt.name = "Dirt";
tiletypes.exit.name = "An Entrance";
tiletypes.forest.name = "Trees";
tiletypes.grass.name = "Grass";
tiletypes.gravel.name = "Gravel";
tiletypes.highrock.name = "High Rocks";
tiletypes.rock.name = "Rocks";
tiletypes.sand.name = "Sand";
tiletypes.sandstone.name = "Sandstone";
tiletypes.shallowwater.name = "Shallow Sea Water";
tiletypes.snow.name = "Snow";
tiletypes.stonewall.name = "Stone Wall";
//tiletypes.stonewall_north.name = "Stone Wall"; //Removed 1.7.2
tiletypes.swamp.name = "Swamp";
tiletypes.water.name = "Sea Water";
tiletypes.clay.name = "Clay";
tiletypes.sandstonewall.name = "Sandstone Wall";
//tiletypes.sandstonewall_north.name = "Sandstone Wall"; //Removed 1.7.2
tiletypes.sandstonefloor.name = "Sandstone Floor";
tiletypes.palm.name = "Palm Trees";
tiletypes.barepalm.name = "Bare Palm Trees";
tiletypes.bareforest.name = "Bare Trees";
tiletypes.woodenwall.name = "Wooden Wall";
//tiletypes.woodenwall_north.name = "Wooden Wall"; //Removed 1.7.2
tiletypes.woodenfloor.name = "Wooden Floor";
tiletypes.woodendoor.name = "Wooden Door";
tiletypes.freshdeepwater.name = "Deep Fresh Water";
tiletypes.freshshallowwater.name = "Shallow Fresh Water";
tiletypes.freshwater.name = "Fresh Water";
//Added All 1.7.2
tiletypes.ironrock.name = "Rocks with Iron";
tiletypes.ironsandstone.name = "Sandstone with Iron";
tiletypes.talcrock.name = "Rocks with Talc";
tiletypes.limestonerock.name = "Rocks with Limestone";
tiletypes.berryforest.name = "Trees with Berries";
tiletypes.fungusforest.name = "Trees with Tree Fungus";
tiletypes.vineforest.name = "Trees with Vines";
tiletypes.coconutpalm.name = "Palm Trees with Coconuts";
//End Added
tiletypes.coalrock.name = "Rocks with Coal"; //Added 1.8.1
tiletypes.nitersandstone.name = "Sandstone with Niter"; //Added 1.9.2

//Player
//Edited All 1.7.2
player.skillTypes.lumberjacking.name = "Lumberjacking";
...
player.skillTypes.mining.name = "Mining";
...
player.skillTypes.cooking.name = "Cooking";
player.skillTypes.cooking.description = "Influences decay of cooked items.";
player.skillTypes.camping.name = "Camping";
...
player.skillTypes.tinkering.name = "Tinkering";
...
player.skillTypes.tactics.name = "Tactics";
...
player.skillTypes.parrying.name = "Parrying";
...
player.skillTypes.mycology.name = "Mycology";
...
player.skillTypes.botany.name = "Botany";
...
player.skillTypes.tailoring.name = "Tailoring";
...
player.skillTypes.fishing.name = "Fishing";
...
player.skillTypes.anatomy.name = "Anatomy";
...
player.skillTypes.trapping.name = "Trapping";
...
//Hints
hints.welcometowayward.name = "Welcome to Wayward";
...
hints.controls.name = "Controls"; //Added 1.8.1
